...
class Tiles:
    ...
    TILE_LIST = [
        ("empty",      Tile(0,  Sprites.NULL_TILE,    False, False,   None,   None)),
        ("ocean",      Tile(1,  Sprites.WATER,        False, True,    None,   None)),
        ("water",      Tile(2,  Sprites.WATER,        False, True,    None,   None)),
        ("river",      Tile(3,  Sprites.WATER,        False, True,    None,   None)),
        ("sand",       Tile(4,  Sprites.SAND,         False, False,   5,      1   )),
        ("dirt",       Tile(5,  Sprites.DIRT,         False, False,   6,      1   )),
        ("hole",       Tile(6,  Sprites.HOLE,         False, False,   None,   None)),
